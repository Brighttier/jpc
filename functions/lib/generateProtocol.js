...
exports.getUserProtocol = exports.generatePersonalizedProtocol = void 0;
 ...
 */
exports.generatePersonalizedProtocol = functions
    ...
    const peptideContext = peptideSnapshot.docs.map(doc => {
        ...
        return {
            name: p.name,
            category: p.category,
            benefits: ((_a = p.primaryBenefits) === null || _a === void 0 ? void 0 : _a.join(', ')) || '',
            goalScores: p.goalRelevance || {},
            injuryScores: p.injuryRelevance || {},
            dosing: p.dosing || {},
            safety: ((_b = p.safety) === null || _b === void 0 ? void 0 : _b.warningLevel) || 'moderate',
            synergies: ((_c = p.synergies) === null || _c === void 0 ? void 0 : _c.complementaryPeptides) || []
        };
    });
    // Get Gemini API key
...
- Primary Goals: ${((_b = assessment.goals) === null || _b === void 0 ? void 0 : _b.join(', ')) || 'General wellness'}
- Current Injuries/Conditions: ${((_c = assessment.injuries) === null || _c === void 0 ? void 0 : _c.join(', ')) || 'None reported'}
...

{
    ...
    "generalGuidance": "HTML paragraph with personalized advice (use <p>, <strong>, <ul> tags). Address their specific goals: ${(_d = assessment.goals) === null || _d === void 0 ? void 0 : _d.join(', ')}. ${((_e = assessment.injuries) === null || _e === void 0 ? void 0 : _e.length) ? 'Consider their reported conditions: ' + assessment.injuries.join(', ') : ''}"
}
 ...
 */
exports.getUserProtocol = functions
    ...
    const db = admin.firestore();
    let query = db.collection('user_protocols')
        .where('status', '==', 'ready');
    if (userId) {
...
//# sourceMappingURL=generateProtocol.js.map