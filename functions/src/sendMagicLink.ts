 ...
 */
export const sendProtocolMagicLink = functions
    .runWith({ timeoutSeconds: 30, memory: '256MB' })
    .https.onCall(async (data: { assessmentData: AssessmentData }, context) => {
 ...
 */
export const verifyMagicLink = functions
    .runWith({ timeoutSeconds: 30, memory: '256MB' })
    .https.onCall(async (data: { token: string; assessmentId: string }) => {
